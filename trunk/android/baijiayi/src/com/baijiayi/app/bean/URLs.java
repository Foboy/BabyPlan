...
public class URLs implements Serializable {
	...
	public final static String BHOST="www.360baijiayi.com";
	
	
	public final static String HOST = "www.360baijiayi.com";//192.168.1.213  www.oschina.net
	...
	public final static String BHTTP=HTTP + BHOST;
	
	public final static String BUPDATE_VERSION = HTTP + BHOST + URL_SPLITTER+"MobileAppVersion.xml";
	
	public final static String GOODS_LIST =HTTP + BHOST + URL_SPLITTER+"Trade/AjaxGetGoods";
	public final static String GOODS_DETAIL =HTTP + BHOST + URL_SPLITTER+"Trade/GetGoodsDetail";
	
	public final static String PUB_GOODS_PIC =HTTP + BHOST + URL_SPLITTER+"Upload/Uploader";
	
	public final static String LOGIN_URL = HTTP + BHOST + URL_SPLITTER+"Account/AjaxLogin";
	public final static String REGISTER_URL = HTTP + BHOST + URL_SPLITTER+"Account/AjaxRegister";
	
	
	public final static String GOODS_PUB = HTTP + BHOST + URL_SPLITTER+"User/AjaxAddGoods";
	
	public final static String USER_SET = HTTP + BHOST + URL_SPLITTER+"User/AjaxUserSetting";
	
	public final static String GOODSCOMMENT_LIST = HTTP + BHOST + URL_SPLITTER+"Trade/GetReplys/";
