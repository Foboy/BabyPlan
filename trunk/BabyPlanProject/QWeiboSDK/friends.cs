...
namespace QWeiboSDK
{
     public class friends : QWeiboApiBase
    {
         ...
         public string user_speciallist(int reqnum, int startindex, string name)
        {
         ...
         public string fanslist_s(int reqnum, int startindex)
         {
             List<Parameter> paras = new List<Parameter>();
             ...
             return base.SyncRequest(TypeOption.TXWB_FRIENDS_USER_FANSLIST_S, paras, null);
         }

         public string idollist_s(int reqnum, int startindex)
         {
             List<Parameter> paras = new List<Parameter>();
             ...
             return base.SyncRequest(TypeOption.TXWB_FRIENDS_USER_IDOLLIST_S, paras, null);
         }
