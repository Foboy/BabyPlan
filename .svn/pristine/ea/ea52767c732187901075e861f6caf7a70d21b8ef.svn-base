...
namespace QWeiboSDK
{
    ...
    public  class t : QWeiboApiBase
    {
        ...
        public string add_video_prev(string content, string clientip, string jing,
                    string wei, int vid)
        {
            List<Parameter> paras = new List<Parameter>();
            ...
            paras.Add(new Parameter("jing", jing));
            paras.Add(new Parameter("wei", wei));
            paras.Add(new Parameter("vid", vid.ToString()));

            return base.SyncRequest(TypeOption.TXWB_T_ADD_VIDEO_PREV, paras, null);
        }
    }
}
