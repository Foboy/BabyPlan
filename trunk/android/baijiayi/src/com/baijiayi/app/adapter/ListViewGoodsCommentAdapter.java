...
import com.baijiayi.app.widget.LinkView;
 ...
 * @created 2012-3-21
 */
public class ListViewGoodsCommentAdapter extends BaseAdapter {
	private Context 					context;//运行上下文
	private List<CommentModel> 				listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewGoodsCommentAdapter(Context context, List<CommentModel> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		CommentModel comment = listItems.get(position);
		String faceURL = comment.getAuthor().getPic().getSPicUrl();
		...
		listItemView.date.setText(StringUtils.friendly_time(comment.getCreateTime()));
