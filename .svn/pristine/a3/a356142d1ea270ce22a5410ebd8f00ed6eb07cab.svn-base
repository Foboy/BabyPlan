...
namespace AMicroblogAPI.Common
{
    ...
    public static class APIUri
    {
        ...
        /// <remarks/>
        public static readonly string GetRateLimitStatus = string.Format("{0}account/rate_limit_status.json", WeiboUriPrefix);

        /// <remarks/>
        public static readonly string UpdateProfileImage = string.Format("{0}account/update_profile_image.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string FriendsTimeline = string.Format("{0}statuses/friends_timeline.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string GetCountersOfCommentNForward = string.Format("{0}statuses/counts.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string GetUserSearchSuggestions = string.Format("{0}search/suggestions/at_users.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string GetFollowingUserIDs = string.Format("{0}friendships/friends/ids.json", WeiboUriPrefix);

        /// <remarks/>
        public static readonly string GetFollowerUserIDs = string.Format("{0}friendships/followers/ids.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string DeleteMultipleFromFavorite = string.Format("{0}favorites/destroy_batch.json", WeiboUriPrefix);
        ...
        /// <remarks/>
        public static readonly string GetShortUrlSharedCount = string.Format("{0}short_url/share/counts.json", WeiboUriPrefix);

        /// <remarks/>
        public static readonly string GetShortUrlSharedStatuses = string.Format("{0}short_url/share/statuses.json", WeiboUriPrefix);

        /// <remarks/>
        public static readonly string GetShortUrlCommentCount = string.Format("{0}short_url/comment/counts.json", WeiboUriPrefix);

        /// <remarks/>
        public static readonly string GetShortUrlComments = string.Format("{0}short_url/comment/comments.json", WeiboUriPrefix);
