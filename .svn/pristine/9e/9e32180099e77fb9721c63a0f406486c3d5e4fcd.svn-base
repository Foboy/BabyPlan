...
namespace AMicroblogAPI
{
    ...
    public static partial class AMicroblog
    {
        ...
        public static string GetAuthorizationUri(string redirectUri, string responseType = null, string state = null, string display = null)
        {
            var requester = new HttpGet(APIUri.Authorize);
            requester.Params.Add("client_id", Environment.AppKey);
        ...
        /// <returns></returns>
        public static OAuthAccessToken GetAccessTokenByAuthorizationCode(string authorizationCode, string redirectUri)
        {
            ValidateArgument(authorizationCode, "authorizationCode");

            var requester = new ObtainTokenPost(APIUri.AccessToken);
            requester.Params.Add("client_id", Environment.AppKey);
            requester.Params.Add("client_secret", Environment.AppSecret);
            ...
            var token = JsonSerializationHelper.JsonToObject<OAuthAccessToken>(response);
        ...
        public static OAuthAccessToken RefreshAccessToken(string refreshToken)
        {
            ...
            var requester = new HttpGet(APIUri.AccessToken);
            requester.Params.Add("client_id", Environment.AppKey);
            requester.Params.Add("client_secret", Environment.AppSecret);
        ...
        public static OAuthAccessToken GetAccessTokenByPassword(string userName, string password)
        {
            ValidateArgument("username", userName);
            ValidateArgument("password", password);

            var requester = new HttpPost(APIUri.AccessToken);
            requester.Params.Add("client_id", Environment.AppKey);
            requester.Params.Add("client_secret", Environment.AppSecret);
        ...
        public static UserInfo GetUID()
        {
            var requester = new OAuthHttpGet(APIUri.GetUID);
        ...
        public static StatusInfo GetStatus(long statusID)
        {
            ...
            var requester = new OAuthHttpGet(APIUri.ShowStatus);
        ...
        /// <returns>The posted status.</returns>
        public static StatusInfo PostStatus(UpdateStatusInfo updateStatusInfo, OAuthAccessToken token = null)
        {
            // Validates arguments
            ...
            customParams.Add(new ParamPair("status", updateStatusInfo.Status));
            ...
            var requester = new OAuthHttpPost(APIUri.UpdateStatus, customParams, token);
        ...
        public static StatusInfo DeleteStatus(long statusID)
        {
            ...
            var requester = new OAuthHttpPost(APIUri.DeleteStatus);
        ...
        public static CommentInfo DeleteComment(long commentID)
        {
            ...
            var requester = new OAuthHttpPost(APIUri.DeleteComment);
        ...
        {
            var requester = new OAuthHttpGet(APIUri.FriendsTimeline); // The same as HomeTimeline
        ...
        public static Collection<CounterInfo> GetCountersOfCommentNForward(long[] statusIDs)
        {
        ...
        /// <returns></returns>
        public static UnreadInfo GetUnreadInfo(long userID)
        {
            // TODO: Not working
            var requester = new HttpGet(APIUri.GetUnreadInfo);

            requester.Params.Add("source", Environment.AppSecret);
        ...
        public static Collection<EmotionInfo> GetEmotions(EmotionType emotionType = EmotionType.Image, string language = "")
        {
        ...
        /// <param name="userID">The user id.</param>
        /// <returns>The user info.</returns>
        public static UserInfo GetUserInfo(long userID, OAuthAccessToken token = null)
        {
            var requester = new OAuthHttpGet(string.Format("{0}.json", APIUri.GetUserInfo, userID), token);
        ...
        public static UserInfo GetUserInfo(string screenName)
        {
            ...
            var requester = new OAuthHttpGet(string.Format("{0}.json", APIUri.GetUserInfo));
        ...
        public static Collection<UserSuggestionInfo> GetUserSearchSuggestions(string keyword, int type = 0, int? count = null, int? range = null)
        {
            ValidateArgument("keyword", keyword);
        ...
        public static RelationshipInfo GetFriendshipInfo(long sourceUserID, long targetUserID)
        {
        ...
        /// <returns>The info of the friendship.</returns>
        public static RelationshipInfo GetFriendshipInfo(string sourceUserScreenName, string targetUserScreenName)
        {
        ...
        public static UserIDs GetFollowingUserIDs(long userID, int? cursor = null, int? count = null)
        {
        ...
        /// <param name="count">The count of a page. If not provided, defaults to 20.</param>
        /// <returns>The user ids.</returns>
        public static UserIDs GetFollowingUserIDs(string screenName, int? cursor = null, int? count = null)
        {
            ValidateArgument(screenName, "screenName");
        ...
        /// <param name="count">The count of a page. If not provided, defaults to 20.</param>
        /// <returns>The user ids.</returns>
        public static UserIDs GetFollowerUserIDs(long userID, int? cursor = null, int? count = null)
        {
        ...
        /// <param name="count">The count of a page. If not provided, defaults to 20.</param>
        /// <returns>The user ids.</returns>
        public static UserIDs GetFollowerUserIDs(string screenName, int? cursor = null, int? count = null)
        {
            ValidateArgument(screenName, "screenName");
            var requester = new OAuthHttpGet(APIUri.GetFollowerUserIDs);
        ...
        public static Collection<TagInfo> GetTags(long userID, int? page = null, int? count = null)
        {
        ...
        /// <param name="page">The page no.</param>
        /// <returns>The tags returned.</returns>
        public static Collection<TagInfo> GetSuggestedTags(int? page = null, int? count = null)
        {
        ...
        public static Collection<TagID> CreateTags(params string[] tags)
        {
        ...
        public static Collection<TagID> DeleteTags(params long[] tagIDs)
        {
        ...
        public static Collection<TrendInfo> GetUserTrends(long userID, int? page = null, int? count = null)
        {
