    ...
    public class ProductServiceClient : IProductService
    {
        ...
        public AdvancedResult<List<ProProduct>> LoadInterestingBB(string token)
        {
            ...
            try
            {
                ...
                {
                    PageEntity<ProProduct> bblist = new PageEntity<ProProduct>();
                    bblist = ProProductAccessor.Instance.Search(0, ItemType.Ignore,ItemSort.Ignore,PriceRange.Ignore,SexType.Ignore, 0, 8);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        PageEntity<ProProduct> bblist = new PageEntity<ProProduct>();
                        bblist = ProProductAccessor.Instance.Search(bbage, ItemType.Ignore,ItemSort.Ignore,PriceRange.Ignore, SexType.Ignore, 0, 8);
