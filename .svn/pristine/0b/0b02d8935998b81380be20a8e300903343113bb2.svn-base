...
public class ListViewMessageDetailAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(msg.getAuthorId() == ac.getLoginUid())
		{
			...
			listItemView.userface2.setVisibility(View.VISIBLE);
			listItemView.userface1.setVisibility(View.GONE);
			...
			listItemView.userface1.setVisibility(View.VISIBLE);
			listItemView.userface2.setVisibility(View.GONE);
